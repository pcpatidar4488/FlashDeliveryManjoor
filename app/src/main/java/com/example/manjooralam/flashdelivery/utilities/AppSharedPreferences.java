package com.example.manjooralam.flashdelivery.utilities;
...
public class AppSharedPreferences {
    ...
    public static enum PREF_KEY {
        USER_ID("user_id"),
        ISLOGIN("is_login"),
        FB_TOKEN("fb_token"), FIREBASE_ACCESS_TOKEN("firebase_access_token"), FULL_NAME("full_name"), MOBILE_NUMBER("mobile_number"), EMAIL_ID("email_id"), USER_IMAGE("url_image");
