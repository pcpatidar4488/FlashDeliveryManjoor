...
public class ShoppingHistoryAdapter extends RecyclerView.Adapter<ShoppingHistoryAdapter.MyViewHolder> {
    ...
    public ShoppingHistoryAdapter(Context context, List<FruitsAndVegitableModel> newArrivalItemList) {
    ...
    @Override
    public void onBindViewHolder(ShoppingHistoryAdapter.MyViewHolder holder, int position) {
