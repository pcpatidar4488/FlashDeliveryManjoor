...
public class CakesAndFlowerAdapter extends RecyclerView.Adapter<CakesAndFlowerAdapter.MyViewHolder> {
    ...
    public CakesAndFlowerAdapter(Context context, List<FruitsAndVegitableModel> newArrivalItemList) {
